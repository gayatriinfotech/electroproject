                                                    ...
                                                    <div class="white_card_body">
                                                        ...
                                                        <form action="{{route('category.update',$cate->id)}}" method="post" enctype="multipart/form-data"> 
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Category Name" name="categoryname" value="{{$cate->cname}}">
                                                                @error('categoryname')
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <img src="{{asset('images')}}/{{$cate->image}}" height="50px" width="50px"/>
